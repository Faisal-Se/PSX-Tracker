        ...
        <div className="relative flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <p className="text-white/50 mt-4 text-sm leading-relaxed max-w-sm">
              Get PKR 1,000,000 in virtual cash to practice trading on the
              Pakistan Stock Exchange. Zero risk, real learning.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-muted-foreground mt-1.5 mb-8">
            Start trading with PKR 1,000,000 virtual cash
          </p>
